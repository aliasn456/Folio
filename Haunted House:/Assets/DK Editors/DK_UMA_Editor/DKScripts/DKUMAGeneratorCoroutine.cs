...
public class DKUMAGeneratorCoroutine : WorkerCoroutine
{
	DKTextureProcessIndieCoroutine textureProcessPROCoroutine;
	DKTextureProcessIndieCoroutine textureProcessIndieCoroutine;
...
// Added by DK	
    public void EditorStart()
    {
		...
		if(umaGenerator.usePRO){
			textureProcessPROCoroutine = new DKTextureProcessIndieCoroutine();
		}else{
			textureProcessIndieCoroutine = new DKTextureProcessIndieCoroutine();
		}
